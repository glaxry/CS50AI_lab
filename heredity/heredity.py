...
def normalize(probabilities):
    ...
    for person in probabilities:
    	sum1 = probabilities[person]["gene"][0] + probabilities[person]["gene"][1] + probabilities[person]["gene"][2]
    	for i in range(0, 3):
    		probabilities[person]["gene"][i] = probabilities[person]["gene"][i] / sum1 
    	sum2 = probabilities[person]["trait"][True] + probabilities[person]["trait"][False]
    	probabilities[person]["trait"][True] = probabilities[person]["trait"][True] / sum2
    	probabilities[person]["trait"][False] = probabilities[person]["trait"][False] /sum2
